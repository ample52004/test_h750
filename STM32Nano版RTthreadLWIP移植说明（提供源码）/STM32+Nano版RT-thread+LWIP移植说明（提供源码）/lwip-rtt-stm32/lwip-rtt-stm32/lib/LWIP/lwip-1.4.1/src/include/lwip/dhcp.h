...
struct dhcp
{
  ...
  /* 输出的报文的pbuf pbuf of outcoming msg */ 
  struct pbuf *p_out; /* pbuf of outcoming msg */
  /* 输出的报文 outgoing msg */  
  struct dhcp_msg *msg_out; /* outgoing msg */
  /* 输出的报文的选项长度 outgoing msg options length */  
  ...
  //dhcp报文选项字段中的时间
  /* 租借地址的时间 lease period (in seconds) */
  u32_t offered_t0_lease; /* lease period (in seconds) */
  /* 续租的时间 recommended renew time (usually 50% of lease period) */
  u32_t offered_t1_renew; /* recommended renew time (usually 50% of lease period) */
  /* 租约重新设定的时间 recommended rebind time (usually 66% of lease period)  */
