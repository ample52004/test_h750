...
#else
#define SYS_LIGHTWEIGHT_PROT    1//为1时使用实时操作系统的轻量级保护
#endif
...
//无操作系统时采用RAM编程接口，使用操作系统时使用NETCONN API
#if !NO_SYS
...
#define TCPIP_THREAD_STACKSIZE          1600	//内核任务堆栈大小
