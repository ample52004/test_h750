...
{
    char DataBuffer[LOG_RECORD_SIZE] = {0};
    ...
    SOE_LogSave("rt_hw_hard_fault_exception");
    sprintf(DataBuffer,"Psr:0x%08x",context->exception_stack_frame.psr);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r00:0x%08x",context->exception_stack_frame.r0);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r01:0x%08x",context->exception_stack_frame.r1);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r02:0x%08x",context->exception_stack_frame.r2);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r03:0x%08x",context->exception_stack_frame.r3);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r04:0x%08x",context->r4);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r05:0x%08x",context->r5);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r06:0x%08x",context->r6);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r07:0x%08x",context->r7);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r08:0x%08x",context->r8);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r09:0x%08x",context->r9);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r10:0x%08x",context->r10);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r11:0x%08x",context->r11);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer,"r12:0x%08x",context->exception_stack_frame.r12);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer," lr:0x%08x",context->exception_stack_frame.lr);
    SOE_LogSave(DataBuffer);
    sprintf(DataBuffer," pc:0x%08x",context->exception_stack_frame.pc);
    SOE_LogSave(DataBuffer);
    ...
    {
        sprintf(DataBuffer,"hard fault on thread: %s",rt_thread_self()->name);
        SOE_LogSave(DataBuffer);
    ...
    {
        SOE_LogSave("hard fault on handler");
        rt_kprintf("hard fault on handler\r\n\r\n");
    }

    if ( (exception_info->exc_return & 0x10) == 0)
    {
        SOE_LogSave("FPU active!");
